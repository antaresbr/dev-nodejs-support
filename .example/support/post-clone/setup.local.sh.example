...
[ -z "${PC_IGNORE_CREATE_LINKS_TO_BASE_SCRIPTS}" ] || pLinksToBaseScripts=no
if [ -z "${pLinksToBaseScripts}" ]
then
  echo""
  envVarRead "Create links to base scripts?" "pLinksToBaseScripts" "default:$(wsCoalesce "${default_pLinksToBaseScripts}" "yes")|lower-case|hide-values" "y|yes|n|no"
fi
...
echo ""
echo "pLinksToBaseScripts   : ${pLinksToBaseScripts}"
...
pLinksToBaseScripts=\"${pLinksToBaseScripts}\"
